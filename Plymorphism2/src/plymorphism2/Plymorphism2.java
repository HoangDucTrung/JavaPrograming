...
class IndependenceDay extends Movie {
    ...
    @Override
    public String plot() {
        return "Aliens attempt to take over planet earth"; //To change body of generated methods, choose Tools | Templates.
    }
}
